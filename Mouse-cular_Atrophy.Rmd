...
frag.file <- here("data","Ctl-D", "for_SIGNAC", "atac_fragments.tsv.gz") # Don't forget to change this part, if there is an issue with this part try the following bash script : 
...
The integration is not working yet
